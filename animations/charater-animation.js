...
class AdvancedPlayerController {
    ...
    // 🔥 Match animation speed with movement speed
 ...
 takeDamage(amount) {
    ...
    die() {
        console.log("☠️ Player is dead! Game Over.");
        this.fadeToAction('idle', 0.2);
...
class Enemy {
    ...
    attackPlayer() {
        console.log("⚔️ Enemy hits player!");
        player.takeDamage(25); // call player’s health system
    }
}
