...
// Ensure 'getGroundPlaneIntersection' is defined and works correctly (it seems to be used).
// This function calculates where the ray from the camera hits the ground plane (Y=0).
function getGroundPlaneIntersection() {
    raycaster.setFromCamera(mouse, camera);
    const plane = new THREE.Plane(new THREE.Vector3(0, 1, 0), 0); // Assuming Y=0 is the ground plane
