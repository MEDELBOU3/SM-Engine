...
Restart SM Engine after updating, then click **AI Assistant** in the top workspace toolbar. Paste a Gemini API key from Google AI Studio, choose **Gemini 3.5 Flash-Lite**, and press **Save**.
