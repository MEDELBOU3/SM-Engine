...
class Animation2DManagerAdvanced extends Animation2DManager {
    ...
    update3DUnderlay() {
        ...
        if (this.render3DOverlay && this.isActive) {
            const opacity = Math.max(0.05, Math.min(1, Number(this.overlayOpacity) || 0.3));
    ...
    bindExportControls() {        const progressRow = document.getElementById('exp2d-progress-row');
    ...
    render() {
        ...
        // Current strokes — draw directly without simplification during live render
